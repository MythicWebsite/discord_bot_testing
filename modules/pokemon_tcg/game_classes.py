...
class PokeCard():
    def __init__(self, card: dict) -> None:
        ...
        self.abilities: list[dict] = card.get("abilities", [])
        self.attacks: list[dict] = card.get("attacks", [])
        self.weaknesses: list[dict] = card.get("weaknesses", [])
        self.resistances: list[dict] = card.get("resistances", [])
...
class PokePlayer():
    def __init__(self, user: User, deck: list[PokeCard], info_thread: Thread) -> None:
        ...
        self.temp_discard: list[PokeCard] = []
